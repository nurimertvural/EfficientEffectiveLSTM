...
lstm1.setOptimizer('SGD', 'LRate', 0.3);
[err_sgd, k_err_sgd] = lstm1.train();

lstm1.setOptimizer('RmsProp', 'LRate', 0.006);
[err_rms, k_err_rms] = lstm1.train();

lstm1.setOptimizer('Adam', 'LRate', 0.003);
[err_adam, k_err_adam] =  lstm1.train();

%% LSTM - EKF, DEKF
lstm1.setOptimizer('EKF',  'P', 100, 'Rinit', 10, 'Rlast', 3, 'Qinit', 1e-4, 'Qlast', 1e-6);
[err_ekf, k_err_ekf] = lstm1.train();

lstm1.setOptimizer('DEKF', 'P', 100, 'Rinit', 10, 'Rlast', 3, 'Qinit', 1e-4, 'Qlast', 1e-6);
